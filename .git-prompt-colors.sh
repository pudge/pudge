...
#     GIT_PROMPT_SUFFIX=')_LAST_COMMAND_INDICATOR_'                 # the end of the git info string
    ...
    GIT_PROMPT_MASTER_BRANCH="${BoldCyan}" # used if the git branch that is active in the current directory is $GIT_PROMPT_MASTER_BRANCHES
    ...
    GIT_PROMPT_REMOTE=" ${Blue}"                 # the remote branch name (if any) and the symbols for ahead and behind
